...
#include <stddef.h>
#include "realsense_camera_msgs/msg/imu_info__rosidl_typesupport_introspection_c.h"
#include "realsense_camera_msgs/msg/rosidl_typesupport_introspection_c__visibility_control.h"
...
static rosidl_typesupport_introspection_c__MessageMember IMUInfo__rosidl_typesupport_introspection_c__IMUInfo_message_member_array[4] = {
  {
    ...
    offsetof(realsense_camera_msgs__msg__IMUInfo, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    12,  // array size
    false,  // is upper bound
    offsetof(realsense_camera_msgs__msg__IMUInfo, data),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(realsense_camera_msgs__msg__IMUInfo, noise_variances),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(realsense_camera_msgs__msg__IMUInfo, bias_variances),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers IMUInfo__rosidl_typesupport_introspection_c__IMUInfo_message_members = {
  "realsense_camera_msgs__msg",  // message namespace
  "IMUInfo",  // message name
  4,  // number of fields
  sizeof(realsense_camera_msgs__msg__IMUInfo),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_realsense_camera_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, realsense_camera_msgs, msg, IMUInfo)() {
