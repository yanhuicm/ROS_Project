...
#include "realsense_camera_msgs/msg/imu_info__rosidl_typesupport_fastrtps_c.h"
...
using _IMUInfo__ros_msg_type = realsense_camera_msgs__msg__IMUInfo;
...
static uint32_t _IMUInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_realsense_camera_msgs__msg__IMUInfo(
...
{
  return max_serialized_size_realsense_camera_msgs__msg__IMUInfo(
    full_bounded, 0);
}
