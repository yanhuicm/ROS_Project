...
#include "realsense_camera_msgs/msg/extrinsics__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_realsense_camera_msgs
...
using _Extrinsics__ros_msg_type = realsense_camera_msgs__msg__Extrinsics;
...
size_t get_serialized_size_realsense_camera_msgs__msg__Extrinsics(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Extrinsics__ros_msg_type * ros_message = static_cast<const _Extrinsics__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Extrinsics__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_realsense_camera_msgs__msg__Extrinsics(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_realsense_camera_msgs
size_t max_serialized_size_realsense_camera_msgs__msg__Extrinsics(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_realsense_camera_msgs__msg__Extrinsics(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, realsense_camera_msgs, msg, Extrinsics)() {
