...
#include "realsense_camera_msgs/msg/extrinsics__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const realsense_camera_msgs::msg::Extrinsics & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  realsense_camera_msgs::msg::Extrinsics & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const realsense_camera_msgs::msg::Extrinsics *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<realsense_camera_msgs::msg::Extrinsics *>(
    untyped_ros_message);
...
{
  return &realsense_camera_msgs::msg::typesupport_fastrtps_cpp::_Extrinsics__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, realsense_camera_msgs, msg, Extrinsics)() {
  return &realsense_camera_msgs::msg::typesupport_fastrtps_cpp::_Extrinsics__handle;
}
