...
static const ::rosidl_typesupport_introspection_cpp::MessageMember IMUInfo_message_member_array[4] = {
  {
    ...
    offsetof(realsense_camera_msgs::msg::IMUInfo, header),  // bytes offset in struct
  ...
  },
  {
    ...
    12,  // array size
    false,  // is upper bound
    offsetof(realsense_camera_msgs::msg::IMUInfo, data),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(realsense_camera_msgs::msg::IMUInfo, noise_variances),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(realsense_camera_msgs::msg::IMUInfo, bias_variances),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers IMUInfo_message_members = {
  ...
  4,  // number of fields
  sizeof(realsense_camera_msgs::msg::IMUInfo),
...
{
  return &::realsense_camera_msgs::msg::rosidl_typesupport_introspection_cpp::IMUInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, realsense_camera_msgs, msg, IMUInfo)() {
  return &::realsense_camera_msgs::msg::rosidl_typesupport_introspection_cpp::IMUInfo_message_type_support_handle;
}
