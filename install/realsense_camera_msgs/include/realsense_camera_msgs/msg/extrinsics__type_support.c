...
#include <stddef.h>
#include "realsense_camera_msgs/msg/extrinsics__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember Extrinsics__rosidl_typesupport_introspection_c__Extrinsics_message_member_array[3] = {
  {
    ...
    offsetof(realsense_camera_msgs__msg__Extrinsics, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    9,  // array size
    false,  // is upper bound
    offsetof(realsense_camera_msgs__msg__Extrinsics, rotation),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(realsense_camera_msgs__msg__Extrinsics, translation),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Extrinsics__rosidl_typesupport_introspection_c__Extrinsics_message_members = {
  ...
  3,  // number of fields
  sizeof(realsense_camera_msgs__msg__Extrinsics),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, realsense_camera_msgs, msg, Extrinsics)() {
